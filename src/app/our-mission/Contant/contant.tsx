        ...
        <div className="relative">
          <div className="flex flex-col gap-5 mt-10">
            <h1 className="text-black text-5xl md:text-[120px] font-bold">
              Our{" "}
              <span className="text-[#D46A00]">
                <i>Mission</i>
              </span>
            </h1>

            <p className="text-[22px] md:w-150">
              to help people reclaim their time, attention, and peace of mind in
              a world that never stops demanding it.
            </p>
          </div>
          ...
          <div className="mt-90 md:mt-16 md:w-175 space-y-4">
            <p>
              Minar Ease creates thoughtfully designed offline tools that
              encourage slowing down, breathing deeply, and reconnecting with
              the present moment.
            </p>
            <p>
          ...
          <div className="w-full max-w-2xl text-right">
            <div className="flex flex-col gap-5">
              ...
              <p className="text-2xl">
                ...
                choice people make every day to feel better, think clearer, and
                live more fully.
              </p>
            </div>
            ...
            <div className="mt-50 md:mt-10 space-y-4">
              <p>
                ...
                creativity replaces scrolling, stillness replaces noise, and
                real moments matter more than digital ones.
              </p>
              <p>
                Our vision is to build a global movement around mindful offline
                living — proving that life doesn’t get smaller when you unplug,
                it gets richer.
              </p>
            </div>
          </div>
